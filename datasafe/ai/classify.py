...
THREAT_LABELS = ["Phishing","Ransomware","Vulnerability","Data leak","Fraud","DDoS","Harassment","Doxxing"]
SECTOR_LABELS = ["Media","Finance","Healthcare","Retail","Telecoms","Energy","Other"]
...
_clf = None
THREAT_LABELS = [
    "Phishing","Ransomware","Vulnerability","Data leak","Fraud","DDoS",
    "Harassment","Doxxing"
]
